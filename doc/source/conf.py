...
htmlhelp_basename = 'acis_thermal_checkdoc'
...
latex_documents = [
    (master_doc, 'acis_thermal_check.tex', 'acis\\_thermal\\_check Documentation',
     'John ZuHone', 'manual'),
]
...
man_pages = [
    (master_doc, 'acis_thermal_check', 'acis_thermal_check Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'acis_thermal_check', 'acis_thermal_check Documentation',
     author, 'acis_thermal_check', 'One line description of project.',
     'Miscellaneous'),
]
