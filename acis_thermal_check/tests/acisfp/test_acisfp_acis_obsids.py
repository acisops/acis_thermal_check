...
def test_FEB2122_acis_obsids(answer_store, test_root):
    answer_data = tests_path / "acisfp/answers/FEB2122A_acis_obsids.json"
    fp_rt = RegressionTester(ACISFPCheck, test_root=test_root, sub_dir="acis_obsids")
    fp_rt.check_acis_obsids("FEB2122A", answer_data, answer_store=answer_store)


def test_FEB2822_acis_obsids(answer_store, test_root):
...
def test_MAR0722_acis_obsids(answer_store, test_root):
